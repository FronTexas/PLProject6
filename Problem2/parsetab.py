...
_lr_productions = [
  ...
  ('exp -> atom','exp',1,'p_exp_atom','yacc.py',223),
  ('exp -> quoted_list','exp',1,'p_exp_qlist','yacc.py',227),
  ('exp -> call','exp',1,'p_exp_call','yacc.py',231),
  ('quoted_list -> QUOTE list','quoted_list',2,'p_quoted_list','yacc.py',235),
  ('list -> LPAREN items RPAREN','list',3,'p_list','yacc.py',239),
  ('items -> item items','items',2,'p_items','yacc.py',243),
  ('items -> empty','items',1,'p_items_empty','yacc.py',247),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',251),
  ('item -> atom','item',1,'p_item_atom','yacc.py',255),
  ('item -> quoted_list','item',1,'p_item_list','yacc.py',263),
  ('item -> call','item',1,'p_item_call','yacc.py',267),
  ('item -> empty','item',1,'p_item_empty','yacc.py',271),
  ('call -> LPAREN SIMB items RPAREN','call',4,'p_call','yacc.py',275),
  ('atom -> SIMB','atom',1,'p_atom_simbol','yacc.py',282),
  ('atom -> bool','atom',1,'p_atom_bool','yacc.py',286),
  ('atom -> NUM','atom',1,'p_atom_num','yacc.py',290),
  ('atom -> TEXT','atom',1,'p_atom_word','yacc.py',294),
  ('atom -> <empty>','atom',0,'p_atom_empty','yacc.py',298),
  ('bool -> TRUE','bool',1,'p_bool','yacc.py',302),
  ('bool -> FALSE','bool',1,'p_bool','yacc.py',303),
  ('atom -> NIL','atom',1,'p_nil','yacc.py',315),
]
